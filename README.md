...
🔧 **By day:** Senior Software Engineer at Cognativ Inc., building real-time video analytics engines with Go, Kafka, and AWS IoT Core.
...
→ **Distributed Architectures** using CQRS, DDD, and event-driven design
...
Fiber • NestJS • Django • CQRS • DDD • Hexagonal Architecture • Microservices

**Databases & Messaging**

PostgreSQL (expert) • MySQL • DynamoDB • Redis • Kafka

**Cloud & DevOps**

AWS (S3, Lambda, IoT Core, EC2, SNS, SQS) • Docker • Kubernetes • GitHub Actions
